...
![Version: 2.6.0](https://img.shields.io/badge/Version-2.6.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 6.19.2](https://img.shields.io/badge/AppVersion-6.19.2-informational?style=flat-square)
...
| extraEnvVars | list | `[]` | optional extra env vars for the deployment |
